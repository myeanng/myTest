...
<html>
  <head>
   ...
   <TITLE>登录页面</TITLE> 
<SCRIPT src="./background/js/jquery-1.9.1.min.js" type="text/javascript"></SCRIPT>
...
<SPAN class="u_logo"></SPAN>       
  <INPUT name="account" class="ipt" type="text" placeholder="请输入用户名" value=""> 
   </P>
<P style="position: relative;"><SPAN class="p_logo"></SPAN>         
<INPUT  name="apassword" class="ipt" id="password" type="password" placeholder="请输入密码" value="">   
  </P>
...
href="#">注册</A>  
              <input style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"  type="submit" value="登录" id="btn"/> 
           </SPAN>         </P></DIV></form></DIV>
		   <div style="text-align:center;">
<p>来源:<a href="http://www.mycodes.net/" target="_blank">AAA软件</a></p>
</div></BODY></HTML>
