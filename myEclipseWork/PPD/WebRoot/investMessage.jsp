...
<div>
    <ul class="breadcrumb" style="border: none !important;">
        <li><a href="http://www.ppdai.com">首页</a> <span class="divider">&gt;</span></li>
                    ...
                    <li><a href="myAccount-investMessage?classType=99&dateType=3">待收款查询</a></li>
    </ul>
</div>
<script>
...
<div class="my-f-left fl">
    ...
    <ul class="my-f-l-list">
        ...
        <ul class="my-f-l-list">
            <li><a href="myAccount-investMessage?classType=99&dateType=3" class="on">投资列表</a></li>
                ...
                <div class="my-f-r-top">
				    ...
				    <div class="clearfix" style="height: 129px;">
				        <div class="my-f-r-detail fl">
				            ...
				            <div class="my-f-r-d-bt"><span style="font-size: 19px;">¥</span> ${ljmoney}</div>
				        </div>
				        <div class="my-f-r-detail br-lr fl">
				            <div class="my-f-r-d-top">累计收益率</div>
				            <div class="my-f-r-d-bt">${syl}<span style="font-size: 19px;">%</span> </div>
				
				        </div>
				        <div class="my-f-r-detail fl">
				            <div class="my-f-r-d-top">待收收益</div>
				            <div class="my-f-r-d-bt"><span style="font-size: 19px;">¥</span>${dsmoney}</div>
				        </div>
				    </div>
				</div>
 
                <form action="myAccount-investMessage" method="POST">
    ...
    开始循环               
                     --><tr>
                        ...
                        <td>${duein.loan.title}</td>
                        <td>${duein.period}/${duein.loan.loantime}</td>
                        <td>${duein.principal}/${duein.interest+duein.principal}</td>
                    </tr>
                    <!--
    循环结束               
                -->
