		...
		<div id="wrapA">
			<div id="header">
				<div class="toptool tar">
					<span><a href="form/login.jsp">Home首页</a> | 
						  <a href="#">论坛首页</a> 
					</span>
				</div>
				<table cellspacing="0" cellpadding="0" align="center" width="100%">
					<tr>
						<td class="banner">
							<a href="./"><img src="${pageContext.request.contextPath}/form/images/yellow/logo.png" /> </a>
						</td>
						<td class="banner" id="banner" align="right">
							<img src="${pageContext.request.contextPath}/form/images/yellow/banner.gif" />
						</td>
					</tr>
					<tr>
				...
				<div id="h_guide" class="guide" >
					...
					<c:choose>
						<c:when test="${person == null }">
							...
							<a href="form/addPerson.jsp" >注册</a>
						</c:when>
						<c:otherwise>
							欢迎您, <a href="Person_view.action?account=${person.account}">${person.account }</a> |
							        <a href="Person_exit.action">注销</a>
						</c:otherwise>
					</c:choose>
			...
			<h3 align="center">
				...
				<a href="Board_add1.action">添加板块</a>
			</h3>
		</div>
		</body>
		</html>