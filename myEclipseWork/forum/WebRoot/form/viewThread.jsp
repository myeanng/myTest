		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center">
			<tr>
				<td style="text-align: left;">
					...
					<b> <a
						href="#category.id=${ board.category.id }">${board.category.name }</a> &raquo; <a
						href="#board.id=${ board.id }">${board.name }</a> </b>
				</td>
			</tr>
		</table>
	</div>
		...
		<table width="100%" align="center" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td align="right" style="padding-bottom:.2em">
					<a href="#thread.id=${ thread.id }"><img src="images/yellow/reply.png" /> </a>
					<a href="#board.id=${ board.id }" style="margin-left:.5em"><img src="images/yellow/post.png" id="td_post" /> </a>
				</td>
			</tr>
		</table>
	</div>
							...
							<table style="border:0">
								<tr>
									<td width="1">
										...
										<a href="profile-htm-action-show-uid-281652.html" target="_blank" style="cursor:pointer;">
											<img class="pic" src="http://img1.phpwind.net/attachout/upload/281652.gif" width="100" height="100" border="0" />
										</a>
									</td>
								</tr>
							</table>
