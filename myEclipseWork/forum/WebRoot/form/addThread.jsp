...
<div id="main">
		...
		<table cellspacing="0" cellpadding="0" width="100%" align="center">
			<tr>
				<td style="padding-top: 12px;text-align: left;">
					...
					<b> <a href="#" >${board.category.name }</a> &raquo; 
						<a href="">${board.name }</a>
					</b>
				</td>
			</tr>
	...
	<s:form action="" method="post">
		<s:hidden name="board.id" value="#attr.board.id"></s:hidden>
			...
			<table cellspacing="0" cellpadding="0" width="100%"
				...
				<tr class="tr1">
					...
					<th height="100%" class="r_one" valign="top" id="td_4900235"
						...
						<input type="text" name="thread.title" style="width: 500px; "/>
					</th>
				</tr>
				<tr class="tr1 r_one">
					<th style="width:20%" class="r_two" style="text-align: right">
					...
					<th style="vertical-align:bottom;padding-left:15px;border:0">
						<s:textarea name="thread.content" cssStyle="width: 500px; height: 200px;"></s:textarea>
						<br />
						<br />
