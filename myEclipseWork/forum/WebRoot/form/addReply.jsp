...
<!--		  这里用来保存原帖的id-->
		<s:hidden value="#attr.thread.id" name="thread.id"></s:hidden>
<!--		回复帖子的标题-->
		<s:hidden value="#attr.replay.title" name="replay.title"></s:hidden>
		<div class="t t2">
			<table cellspacing="0" cellpadding="0" width="100%"
				...
				<tr class="tr1 r_one">
					...
					<th style="vertical-align:bottom;padding-left:15px;border:0">
						<s:textarea name="reply.content" cssStyle="width: 500px; height: 200px; "></s:textarea>
						<br />
						<br />
