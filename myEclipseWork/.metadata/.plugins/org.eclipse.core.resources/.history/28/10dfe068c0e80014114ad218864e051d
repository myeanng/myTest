...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./ppd_moneyhistory_files/basic.css">
    <link rel="stylesheet" type="text/css" href="./ppd_moneyhistory_files/layout.css">
    <link href="./ppd_moneyhistory_files/validation-min.css" rel="stylesheet">
    <link rel="shortcut icon" href="http://www.ppdaicdn.com/favicon.ico" type="image/x-icon">
    <script src="./ppd_moneyhistory_files/v.htm" charset="utf-8"></script><script src="./ppd_moneyhistory_files/hm.js"></script><script src="./ppd_moneyhistory_files/analytics.js" async=""></script><script src="./ppd_moneyhistory_files/gtm.js" async=""></script><script src="./ppd_moneyhistory_files/newRefer.js"></script>
    ...
    </script><script src="./ppd_moneyhistory_files/h.js" type="text/javascript"></script>
    
     <link href="./ppd_moneyhistory_files/account.css" rel="stylesheet">


<script src="./ppd_moneyhistory_files/jquery_003.js" type="text/javascript"></script><script src="./ppd_moneyhistory_files/ppd_pop.js" type="text/javascript"></script><script src="./ppd_moneyhistory_files/hubs" type="text/javascript"></script><script src="./ppd_moneyhistory_files/acstatus_hub.js" type="text/javascript"></script></head>
        ...
        <div class="mainNav_inner w1000center clearfix">
            <h1 class="logo">
                <a href="http://www.ppdai.com/">
                    <img src="./ppd_moneyhistory_files/logo.png" alt=""></a>
            </h1>
            <ul id="tabIcon">
                <li class="hasSubMenu">
...
<div class="wrapleftnav fl" style="width: 200px">
    <div class="my-f-left fl">
        ...
        <ul class="my-f-l-list">
            <li><a href="myAccount-moneyhistory?classType=99&dateType=3" class="on">资金记录</a></li>
        ...
        <ul class="my-f-l-list">
            ...
            <li><a href="myAccount-connectNumber">关联账户</a></li>
             ...
             <form action="myAccount-moneyhistory" method="POST">
            <div class="my-f-right fr">
                <div class="my-f-r-top">
                    <h3 class="my-f-r-title"><span class="fl">资金记录</span><span class="my-zj-mark fr"><a href="recharge.jsp" style="color:#39a1ea">充值</a><span class="fs14 c666666 mlr7">|</span><a href="withdrawCash.jsp" style="color:#39a1ea">提现</a></span></h3> 
                    ...
                    <c:forEach items="${user.accounts}" var="account">
                        <div class="my-f-r-detail fl">
                            ...
                            <div class="my-f-r-d-bt"><span style="font-size:19px;">¥</span>${account.allmoney}</div>
                        </div>
                        <div class="my-f-r-detail br-lr fl">
                            <div class="my-f-r-d-top">账户余额</div>
                                <div class="my-f-r-d-bt"><span style="font-size:19px;">¥</span>${account.inmoney}</div>

                        </div>
                        <div class="my-f-r-detail fl">
                            <div class="my-f-r-d-top">冻结资金</div>
                             <div class="my-f-r-d-bt"><span style="font-size:19px;">¥</span>${account.outmoney}</div>
                    ...
                    <div class="my-f-r-m-tab-search clearfix" style="margin-top:0;">
                        <div class="my-f-r-m-tab-sf fl">
                         ...
                         <select name="dateType" id="dateType">
                            ...
                            <input class="my-f-r-m-tab-btn" value="查询" id="btOk" type="submit">
                        </div>
                    </div>
                </div>
                <table class="receivetab c666666" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                        <th>日期</th>
                        <th>类型</th>
                        <th>金额</th>
                    ...
                    <tr>
                        <td><fmt:formatDate value="${b.createtime}" pattern="yyyy-MM-dd hh:mm:ss"/> </td>
                        <td>
                        <c:if test="${b.class_==0}">手续费</c:if>
                        <c:if test="${b.class_==1}">支出</c:if>
                        <c:if test="${b.class_==2}">收入</c:if>
                        </td>
                        <td>${b.money}</td>
                        <td width="200">${b.state}</td>
                    </tr>
                    </c:forEach>
                    </tbody></table>
...
司</p>
    ...
    <script src="./ppd_moneyhistory_files/jquery.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_moneyhistory_files/init.js" type="text/javascript" charset="utf-8"></script>
    <script src="./ppd_moneyhistory_files/servicestack-min.js"></script>
    <script src="./ppd_moneyhistory_files/jquery_002.js"></script>
    <script src="./ppd_moneyhistory_files/status" type="text/javascript"></script><script type="text/javascript" src="./ppd_moneyhistory_files/acstatus.js"></script>
   ...
   <script>
    ...
    <script type="text/javascript">
        ...
        function ClickOK() {
            var link = '/moneyhistory?classType=' + $("#classType").val() + "&dateType=" + $("#dateType").val();
            //alert(link);
            location.href = link;
        }
...
<script src="./ppd_moneyhistory_files/wpa.php" type="text/javascript" charset="utf-8"></script>
