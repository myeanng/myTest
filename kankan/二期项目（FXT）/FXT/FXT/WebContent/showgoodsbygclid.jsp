...
#five a:link,#five2 a:link,#five3 a:link{
text-decoration:none;
color:black;
}
#five a:hover,#five2 a:hover,#five3 a:hover{
text-decoration: none;
color:green;
}
#five a:visited,#five2 a:visited,#five3 a:visited{
text-decoration:none;
color:red;
}
#five3{
...
<div id="five" style="color:black;">
所在位置：<a href="mainShowGoodsServlet">首页</a>——>><a href="#">${gc.gcname }</a>——>><a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=1">${gcl.gclname }</a>
</div>
<div id="five2" style="color:black;">
所有区域：<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=1">金水区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=2">中原区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=3">二七区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=4">管城回族区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=5">惠济区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=6">上街区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=7">高新区</a>
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=8">其它区</a>
</div>
<div id="sex">
<c:forEach items="${goodslist }" var="g">
<div class="a" style="margin-right:5px;"><a href="SelectGoodsServlet1?gid=${g.gid }&xuan=3"><img src="img/${g.pic1 }"></a><div class="b"><a href="SelectGoodsServlet1?gid=${g.gid }&xuan=3"><span class="span1">${g.gname }</span><br><span class="span2">${g.intro }</span></a></div><div class="c"><span class="span3">￥</span><span class="span4">${g.nowprice }</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="span5">门店价</span><span class="span6">￥${g.price }</span></div></div>

</c:forEach>

</div>
<div id="five3">
<a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=1">首页</a>||
<c:choose>
     <c:when test="${ye>1 }">
     <a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=${ye-1}">上一页</a>
     </c:when>
     <c:otherwise>
     上一页
     </c:otherwise>
...
||
<c:choose>
     <c:when test="${ye<countpage }">
     <a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=${ye+1}">下一页</a>
     </c:when>
      <c:otherwise>
     下一页
     </c:otherwise>
...
||
<a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=${countpage}">末页</a>
</div>
</div>
<!--  -->
<div id="shiwu"></div>
