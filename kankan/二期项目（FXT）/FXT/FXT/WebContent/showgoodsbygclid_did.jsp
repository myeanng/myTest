...
#five a:hover,#five3 a:hover{
text-decoration: none;
color:green;
}
#five a:visited,#five3 a:visited{
text-decoration: none;
color:red;
}
#sex{
...
<div id="five">
所在位置：<a href="mainShowGoodsServlet">首页</a>——>><a href="#">${gc.gcname }</a>——>><a href="SelectGoodsByGclidServlet?gclid=${gcl.gclid }&pageindex=1">${gcl.gclname }</a>——>><a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=${di.did }&pageindex=1">${di.dname }</a>
</div>
...
<div id="five3">
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=${di.did }&pageindex=1">首页</a>||
<c:choose>
     <c:when test="${ye>1 }">
     <a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=${di.did }&pageindex=${ye-1}">上一页</a>
     </c:when>
     <c:otherwise>
     上一页
     </c:otherwise>
...
<c:choose>
     ...
     <a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=${di.did }&pageindex=${ye+1}">下一页</a>
     </c:when>
      <c:otherwise>
     下一页
     </c:otherwise>
...
||
<a href="QueryGoodsByGclid_DidServlet?gclid=${gcl.gclid }&did=${di.did }&pageindex=${countpage}">末页</a>
</div>
</div>
<!--  -->
<div id="shiwu"></div>
...
$("#four>ul>li>a").hover(
		...
		function(){
			$(this).css({"background-color":"#2CB8AD","color":"while"});
		}
		);
//此处为顶部轮换广告
var num1=2;
