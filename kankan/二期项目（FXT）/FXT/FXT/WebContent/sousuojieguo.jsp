<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="com.fxt.entity.*"%>
...
background:url(pic/guanggao1.jpg) no-repeat;
}
#five{
...
<div id="b">
<c:choose>
<c:when test="${ empty goodsLists }">抱歉，没有您要找的商品哦！</c:when>
<c:otherwise>
<div id="a">与关键字“${guanjianzi }”有关的商品如下：</div>
<c:forEach items="${goodsLists}" var="g" varStatus="s">

<c:choose>
      <c:when test="${s.count%3==0 }">
      ...
      <c:otherwise>
      <div class="a" style="margin-right:10px;"><a href="SelectGoodsServlet1?gid=${g.gid }&xuan=3"><img src="img/${g.pic1 }"></a><div class="b"><a href="SelectGoodsServlet1?gid=${g.gid }&xuan=3"><span class="span1">${g.gname }</span><br><span class="span2">${g.intro }</span></a></div><div class="c"><span class="span3">￥</span><span class="span4">${g.nowprice }</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="span5">门店价</span><span class="span6">￥${g.price }</span></div></div>
      </c:otherwise>
</c:choose>
</c:forEach>
</c:otherwise>
